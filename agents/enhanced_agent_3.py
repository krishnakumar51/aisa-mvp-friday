    ...
    "analysis_reasoning": "<your_thinking_process>"
        ...
        try:
            llm_response = get_llm_response(step_detection_prompt, 
                "You are an expert automation analyst specializing in step detection and execution monitoring.")
    ...
    "overall_health": "<EXCELLENT|GOOD|FAIR|POOR>"
        ...
        try:
            llm_response = get_llm_response(evaluation_prompt,
                "You are a senior automation engineer with 10+ years of experience in test automation, debugging, and quality assurance.")
...
Format your response as specific bullet points, each with a clear action to take."""
        ...
        try:
            llm_recommendations = get_llm_response(recommendation_prompt,
                "You are a world-class automation engineer and debugging specialist with extensive experience in fixing automation failures.")
    ...
    "confidence": <0.0-1.0>
        ...
        try:
            llm_response = get_llm_response(completion_check_prompt,
                "You are an expert at monitoring automation execution and determining completion status.")
    ...
    "executive_summary": "<brief_summary_for_stakeholders>"
        ...
        try:
            llm_response = get_llm_response(assessment_prompt,
                "You are a senior automation engineer with extensive experience in automation quality assessment and reporting.")
    ...
    "expert_summary": "<brief_expert_assessment>"
        ...
        try:
            llm_response = get_llm_response(log_analysis_prompt,
                "You are a senior automation engineer with expertise in log analysis, debugging, and predictive analysis.")
    ...
    "next_steps": ["<step1>", "<step2>"]
        ...
        try:
            llm_response = get_llm_response(screenshot_analysis_prompt,
                "You are a senior automation engineer with expertise in visual analysis, UI automation, and screenshot-based debugging.")
    ...
    "expert_summary": "<brief_code_analysis_summary>"
        ...
        try:
            llm_response = get_llm_response(code_analysis_prompt,
                "You are a senior automation engineer with expertise in code analysis, performance optimization, and automation reliability.")
    ...
    "reasoning": "<why_these_queries_will_be_effective>"
        ...
        try:
            ...
            llm_response = get_llm_response(query_generation_prompt,
                "You are an expert automation engineer who excels at finding solutions to technical problems.")
...
Respond with just the solutions, one per line, starting with "•"."""
                            ...
                            try:
                                solution_response = get_llm_response(solution_extraction_prompt,
                                    "You are an expert at extracting actionable solutions from technical documentation.")
