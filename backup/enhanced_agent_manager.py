...
# Import all enhanced agents
try:
    print("Attempting to import enhanced_agent_1...")
    from agents.enhanced_agent_1 import run_enhanced_agent1
    print("✓ Enhanced agent 1 imported")
    
    print("Attempting to import enhanced_agent_2...")
    from agents.enhanced_agent_2 import run_enhanced_agent2
    print("✓ Enhanced agent 2 imported")
    
    print("Attempting to import enhanced_agent_3...")
    from agents.enhanced_agent_3 import run_enhanced_agent3
    print("✓ Enhanced agent 3 imported")
    
    ENHANCED_AVAILABLE = True
    print("✓ All enhanced agents available")
